...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 13 2025 г., 01:29
...
CREATE TABLE `warehouse` (
  ...
  `material_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `obrezki_id` int(11) DEFAULT NULL,
...
INSERT INTO `warehouse` (`id`, `storage_type_id`, `material_id`, `product_id`, `obrezki_id`, `amount`, `unit_id`, `entry_date`) VALUES
(1, 1, 1, NULL, NULL, '100.00', 2, '2024-02-01'),
(2, 1, 2, NULL, NULL, '50.00', 2, '2024-02-01'),
(3, 1, 3, NULL, NULL, '200.00', 1, '2024-02-05'),
(4, 2, NULL, 1, NULL, '30.00', 1, '2024-02-10'),
(5, 2, NULL, 2, NULL, '50.00', 1, '2024-02-10'),
(6, 3, NULL, NULL, 1, '2.00', 2, '2025-02-13'),
(7, 3, NULL, NULL, 2, '0.70', 2, '2025-02-13');
...
--
ALTER TABLE `warehouse`
  ADD CONSTRAINT `fk_warehouse_material` FOREIGN KEY (`material_id`) REFERENCES `material` (`id`),
  ADD CONSTRAINT `fk_warehouse_obrezki` FOREIGN KEY (`obrezki_id`) REFERENCES `obrezki` (`id`),
  ADD CONSTRAINT `fk_warehouse_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  ADD CONSTRAINT `fk_warehouse_storage_type` FOREIGN KEY (`storage_type_id`) REFERENCES `storage_type` (`id`),
  ADD CONSTRAINT `fk_warehouse_unit` FOREIGN KEY (`unit_id`) REFERENCES `unit_of_measure` (`id`);
